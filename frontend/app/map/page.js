  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm">
              Full-screen view of all reported problems with heatmap and marker clustering
            </p>
          </div>
          <button
            onClick={handleMyLocation}
            className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-semibold glass border border-purple-500/40 text-purple-300 hover:bg-purple-500/10 transition-all shrink-0"
          >
            📍 Locate Me
          </button>
        </div>
        ...
        {/* Map */}
        <div className="glass rounded-xl overflow-hidden border border-white/5" style={{ height: "70vh" }}>
          {!loading ? (
            <MapView
